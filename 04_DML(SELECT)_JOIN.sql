...
----------------------JOIN 종합 실습문제-----------------
1.
SELECT E.EMP_ID,E.EMP_NAME,J.JOB_CODE,E.DEPT_CODE,N.NATIONAL_NAME,E.SALARY
FROM EMPLOYEE E,JOB J,NATIONAL N,LOCATION L,DEPARTMENT D
...
SELECT EMP_ID,EMP_NAME,JOB_CODE,E.DEPT_CODE,N.NATIONAL_NAME,E.SALARY
FROM EMPLOYEE E
LEFT JOIN JOB J ON (J.JOB_CODE=E.JOB_CODE)
LEFT JOIN LOCATION L ON(D.LOCATION_ID=L.LOCAL_CODE)
LEFT JOIN DEPARTMENT D ON (D.LOCATION_ID=L.LOCAL_CODE)
LEFT JOIN NATIONAL N ON(L.NATIONAL_CODE=N.NATIONAL_CODE);

2.
SELECT EMP_NAME,EMP_NO,J.JOB_CODE,E.DEPT_CODE
FROM EMPLOYEE 
